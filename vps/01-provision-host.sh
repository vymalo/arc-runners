...
log "ulimits for runner users"
cat > /etc/security/limits.d/90-ci-runners.conf <<'EOF'
runner-1  soft  nofile  65536
runner-1  hard  nofile  1048576
runner-2  soft  nofile  65536
runner-2  hard  nofile  1048576
runner-3  soft  nofile  65536
runner-3  hard  nofile  1048576
*  soft  nproc  32768
*  hard  nproc  65536
EOF
